    ...
    // =============================================================================
      ...
      children: [
        ...
        // =============================================================================
        {
          ...
          name: 'cliente',
          component: () => import('./views/registro/cliente/Cliente.vue'),
          meta: {
            breadcrumb: [
              { title: 'Clientes', url: '/' },
        ...
        },
        {
          ...
          name: 'proveedor',
          component: () => import('./views/registro/proveedor/Proveedor.vue'),
          meta: {
            breadcrumb: [
        ...
        },
        {
          ...
          name: 'categoria',
          component: () => import('@/views/registro/producto/categoria/Categoria.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Dashboard' },
              { title: 'Categoria', active: true }
            ],
            pageTitle: 'Categoria',
            rule: 'editor'
          }
        },
        {
          ...
          name: 'marca',
          component: () => import('@/views/registro/producto/marca/Marca.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Dashboard' },
              { title: 'Marca', active: true }
            ],
            pageTitle: 'Marca',
            rule: 'editor'
          }
        },
        {
          path: '/dashboard/tipo',
          name: 'tipo',
          component: () => import('@/views/registro/producto/tipo/Tipo.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Dashboard' },
              { title: 'Tipo', active: true }
            ],
            pageTitle: 'Tipo',
            rule: 'editor'
          }
        },
        {
          ...
          name: 'unidad',
          component: () => import('@/views/registro/producto/unidad/Unidad.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Dashboard' },
              { title: 'Unidad', active: true }
            ],
            pageTitle: 'Unidad',
            rule: 'editor'
          }
        },
        {
          ...
          name: 'producto',
          component: () => import('@/views/registro/producto/producto/Producto.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Dashboard' },
              { title: 'Producto', active: true }
            ],
            pageTitle: 'Producto',
            rule: 'editor'
          }
        ...
        // =============================================================================
        {
          path: '/dashboard/compra',
          name: 'compra',
          component: () => import('./views/movimiento/compra/Compra.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        },
        {
          ...
          name: 'Lista Compras',
          component: () => import('./views/movimiento/compra/ListaCompra.vue'),
          meta: {

              breadcrumb: [
                { title: 'Home', url: '/' },
                { title: 'Dashboard' },
                { title: 'Lista Compras', active: true }
              ],
            rule: 'editor'
            // no_scroll: true
          }
