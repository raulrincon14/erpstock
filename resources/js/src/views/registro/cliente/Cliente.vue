  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="category">Cliente</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.cli_docnum}}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.cli_nombre }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.cli_telefono }}</p>
              </vs-td>
              <vs-td>
                <div v-if="tr.cli_estado === 1">
...
import moduleCliente from '@/store/registro/cliente/moduleCliente.js'
...
export default {
  ...
  computed: {
    ...
    products () {
      return this.$store.state.dataCliente.clientes
  ...
  created () {
    if (!moduleCliente.isRegistered) {
      this.$store.registerModule('dataCliente', moduleCliente)
      moduleCliente.isRegistered = true
    }
    this.$store.dispatch('dataCliente/listarCliente')
  },
  mounted () {
